...
export const ProcrastinationQuestion = () => {
      ...
      <div className="space-y-6">
        ...
        <blockquote className="border-l-4 border-gray-200 pl-4">
          <p className="text-xl font-medium text-gray-800">
            "I start my work promptly without procrastinating"
          </p>
        </blockquote>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4">
        {options.map((option) => (
          <button
            key={option.value}
            onClick={() =>
              updateQuestionnaireData("procrastinationTendency", option.value)
            }
          ...
          >
            <Card
              className={cn(
                ...
                questionnaireData.procrastinationTendency === option.value
