...
export const ScheduleAdherenceQuestion = () => {
      ...
      <div className="space-y-6">
        ...
        <blockquote className="border-l-4 border-gray-200 pl-4">
          <p className="text-xl font-medium text-gray-800">
            "I usually follow through on my planned schedules"
          </p>
        </blockquote>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4">
        {options.map((option) => (
          <button
            key={option.value}
            onClick={() =>
              updateQuestionnaireData("scheduleAdherence", option.value)
            }
          ...
          >
            <Card
              className={cn(
                ...
                questionnaireData.scheduleAdherence === option.value
