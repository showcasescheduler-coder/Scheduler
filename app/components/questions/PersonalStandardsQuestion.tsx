...
export const PersonalStandardsQuestion = () => {
      ...
      <div className="space-y-6">
        ...
        <blockquote className="border-l-4 border-gray-200 pl-4">
          <p className="text-xl font-medium text-gray-800">
            "I set higher standards for myself than others set for me"
          </p>
        </blockquote>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4">
        {options.map((option) => (
          <button
            key={option.value}
            onClick={() =>
              updateQuestionnaireData("personalStandards", option.value)
            }
          ...
          >
            <Card
              className={cn(
                ...
                questionnaireData.personalStandards === option.value
