...
export default function SelfControlOrganization({
  ...
  const statements = [
    "I follow through on most of my planned schedules",
    "I usually start my work without procrastinating",
    "I regularly complete tasks within their allocated time",
  ];
