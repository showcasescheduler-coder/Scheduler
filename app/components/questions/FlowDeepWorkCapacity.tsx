...
export default function MatrixQuestions({
  currentStep,
  totalSteps,
  onNext,
  onPrevious,
  ...
  const statements = [
    "I often lose track of time when I'm working on something interesting",
    "I frequently achieve a state of complete absorption in my work",
    "I can easily resume work after being interrupted",
  ];
